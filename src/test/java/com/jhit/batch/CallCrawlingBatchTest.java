...
@SpringBootTest
public class CallCrawlingBatchTest {
	
	private static final Logger log = LoggerFactory.getLogger(CallCrawlingBatchTest.class);
...
//		ProcessBuilder builder = new ProcessBuilder("java", "-jar" , "TestJar.jar");
//		ProcessBuilder builder = new ProcessBuilder("java", "-cp" , "CallCrawlingStep.jar;", "com.jhit.batch.controller.JobLauncherController");
		ProcessBuilder builder = new ProcessBuilder("java", "-cp" , "TestJar.jar;", "com.jhit.jsoup.openMarketData");
		
		String path = "S:\\git\\repository\\construct.open.db\\jhit.construct.open.db\\bin\\main";
//		String path = "S:\\git\\repository\\construct.open.db\\jhit.construct.open.db\\src\\main\\java\\com\\jhit";
...
//		
		...
		log.debug("call crawling step call");
	}
