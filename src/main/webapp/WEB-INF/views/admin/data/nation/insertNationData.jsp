				...
				<table class="table" style="width: 500px; border: 1px solid #ced4da;">
					...
					<tr class="tr-border">
						...
						<td colspan="3" class="tr-border">
							<input type="text" class="form-control white" name="seKwrd" value="" maxlength="500" />
						</td>
					</tr>
					<tr class="tr-border">
						<td class="tr-border">등록 일자</td>
						<td class="tr-border">
							<input type="text" class="form-control white" name="regDe" value="" placeholder="YYYY-MM-DD" onfocus="this.placeholder=''" onblur="this.placeholder = 'YYYY-MM-DD'" maxlength="14" />
						</td>
					</tr>
					<tr class="tr-border">
						<td class="tr-border">최근 등록 일자</td>
						<td class="tr-border">
							<input type="text" class="form-control white" name="ltCreatDe" value="" placeholder="YYYY-MM-DD" onfocus="this.placeholder=''" onblur="this.placeholder = 'YYYY-MM-DD'" maxlength="14" />
						</td>
					</tr>
				</table>
				<button type="button" class="btn btn-inverse waves-effect waves-light" onclick="saveData();" style="margin: 30px 228px;">저장</button>
			</form>
	</div>
	<!-- container end -->
</main>
