	...
	<!-- container Start-->
		<div class="pcoded-inner-content">
                                                    ...
                                                    <table class="table table-hover text-center">
														...
														<c:if test="${totalCount != 0}">
															<c:forEach items="${lists }" var="dataList">
																<tr class="table-tr">
																	<td> ${dataList.rn }</td>
																	<td onclick="openDetail('${dataList.dataId }');" style="cursor: pointer;">${dataList.dataNm }</td>
			...
			<div  style="padding-left: 90%;">
				<button type="button" onclick="insertOpenData();" class="btn btn-inverse waves-effect waves-light">등록</button>
			</div>
